...
// on defini une structure pour récuperer le nom des joueurs et leur score
...
// et le calcul du temps se fait dans la fonction CalculTemps et aussi on l'étape de comparaison entre le temps des joueurs pour dire qui a gagné
float calculTemps()
{
    char reponse;
    struct joueur j[2];
